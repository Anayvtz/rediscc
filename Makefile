...
LDFLAGS=-g
SRVR_OBJS=./src/srvr/rediscc.o ./src/resp.o ./src/srvr/srvr.o ./src/commands.o ./src/srvr/commands_srvr.o ./src/srvr/memdb.o ./src/srvr/timer_wheel.o ./src/logger.o
CLNT_OBJS=./src/clnt/rediscccli.o ./src/resp.o ./src/commands.o ./src/clnt/commands_clnt.o ./src/clnt/clnt.o ./src/logger.o
